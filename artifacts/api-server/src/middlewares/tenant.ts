...
export async function tenantMiddleware(
  ...
  // Read host from header (works behind proxies too)
  const host =
  ...
  // Manual slug support for local testing (dev only)
  const manualSlug =
  ...
  try {
    ...
    // ✅ Status check – suspend immediately if needed
    ...
    // ✅ Only cache active, non-expired tenants
